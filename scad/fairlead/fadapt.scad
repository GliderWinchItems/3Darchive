/* scad/fairlead/fadapt.scad
 * Magnet stud to flex tubing adaptor
 * Date of latest: 20170903
 */
...
/* Select stud magnet */
magx_thick            = mag20_thick;	       // Magnet thickness (base to shell top)
magx_shell_flat_dia   = mag20_shell_flat_dia;// Dia of flat of magent
magx_stud_dia         = mag20_stud_dia;        // Dia of mounting magnet studs
magx_stud_len         = mag20_stud_len;        // Height of stud from magnet back
magx_washer_thick     = mag20_washer_thick;    // Thickness of washer
magx_nut_thick        = mag20_nut_thick;       // M5 Nut for stud thickness
magx_nut_hex_peak     = mag20_nut_hex_peak;    // M5 nut across peaks (also dia of nut)
magx_washer_dia       = mag20_washer_dia;      // Washer diameter of washer for magnet stud
magx_washer_dia_extra = mag20_washer_dia_extra;// Washer slop

flex_id = 6 - 0.5;	// Inside diameter of flexible tube
flex_len = 10;	// Length adapter inserts into tubing
